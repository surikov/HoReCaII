...
public class ReportObratnaiaSvyazOtKlienta extends Report_Base{
	Numeric dateFrom = new Numeric();
	Numeric dateTo = new Numeric();
	Numeric territory = new Numeric();

	public static String menuLabel(){
		return "Обратная связь от клиента";
	}

	public static String folderKey(){
		return "obratnayaSvayazOtKlient";
	}
	...
	public ReportObratnaiaSvyazOtKlienta(ActivityWebServicesReports p){
		super(p);
	}
	...
	public String composeGetQuery(int queryKind){
		...
		String p = "{\"КлючВарианта\":\"89ef59e8-d6bb-47ad-a787-379c10f5422b\""
		...
		if(propertiesForm == null){
			...
			propertiesForm.child(new Knob(context)//
					...
					.afterTap.is(new Task(){
						@Override
						public void doTask(){
							activityReports.promptDeleteRepoort(ReportObratnaiaSvyazOtKlienta.this, currentKey);
						}
					})//
					.left().is(propertiesForm.shiftX.property.plus(Auxiliary.tapSize * (0.3 + 0 * 2.5)))//
