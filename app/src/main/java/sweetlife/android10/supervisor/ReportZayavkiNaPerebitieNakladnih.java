...
public class ReportZayavkiNaPerebitieNakladnih extends Report_Base {
    Numeric dateCreateFrom = new Numeric();
    Numeric dateCreateTo = new Numeric();
    Numeric territory = new Numeric();
    //Numeric status = new Numeric();
    public  static String menuLabel() {
        return "Заявки на перебитие накладных";
    }
    public static String folderKey() {
        return "statusyZayavkiNaPerebitie";
    }
    ...
    public ReportZayavkiNaPerebitieNakladnih(ActivityWebServicesReports p) {
        super(p);
    }
    @Override
...
/*
        ...
        String serviceName = "ЗаявкиНаПеребитиеНакладных";
        try {
        ...
        if (propertiesForm == null) {
            ...
            propertiesForm.child(new Knob(context)//
                    ...
                    .afterTap.is(new Task() {
                        ...
                        public void doTask() {
                            //expectRequery.start(activityReports);
                            activityReports.promptDeleteRepoort(ReportZayavkiNaPerebitieNakladnih.this, currentKey);
                        }
                    })//
                    .left().is(propertiesForm.shiftX.property.plus(Auxiliary.tapSize * (0.3 + 0 * 2.5)))//
            ...
            if (i - 2 > -1 && i + 1 < strings.length - 1) {
                ...
                if (num.length() > 2) {
                    ...
                    line = line.substring(0, start)//
                            + "№<a href=\"hook"//
                            + "?kind=" + HOOkReportPerebitieNakladnoy//
