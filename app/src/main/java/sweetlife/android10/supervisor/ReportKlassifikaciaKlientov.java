...
public class ReportKlassifikaciaKlientov extends Report_Base {
	...
	public ReportKlassifikaciaKlientov(ActivityWebServicesReports p) {
		super(p);
	}

	public static String menuLabel() {
		return "Классификация клиентов";
	}

	public static String folderKey() {
		return "klassifikaciaKlientov";
	}
	...
	public String composeGetQuery(int queryKind) {
		...
		String p = "{"
				           ...
				           +",\"ВариантОтчета\":\"КлассификацияПоТоварнымГруппам\""//
						   //+",\"Контрагент\":\""+kod+"\""//
						   +kod//
				           +"}";
		String e = "";
		...
		String serviceName="КлассификацияКлиентов";
		try {
	...
	public SubLayoutless getParametersView(Context context) {
		...
		for(int i = 0; i < kontragenty.children.size(); i++) {
			...
			propertiesForm.child(new Knob(context)//
						...
						public void doTask() {
							//expectRequery.start(activityReports);
							activityReports.promptDeleteRepoort(ReportKlassifikaciaKlientov.this, currentKey);
						}
					})//
					                     .left().is(propertiesForm.shiftX.property.plus(Auxiliary.tapSize * (0.3 + 0 * 2.5)))//
