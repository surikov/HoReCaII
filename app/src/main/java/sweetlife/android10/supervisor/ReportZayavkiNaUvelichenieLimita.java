...
public class ReportZayavkiNaUvelichenieLimita extends Report_Base {

	Numeric dateFrom = new Numeric();
	Numeric dateTo = new Numeric();


	public ReportZayavkiNaUvelichenieLimita(ActivityWebServicesReports p) {
		super(p);
	}

	public static String menuLabel() {
		return "Заявки на увеличение лимита";
	}

	public static String folderKey() {
		return "zayavkiNaUvelichLim";
	}
	...
	public String composeGetQuery(int queryKind) {
		...
		String serviceName="УвеличениеЛимита";
		try {
	...
	public SubLayoutless getParametersView(Context context) {
		...
		//}
			...
			propertiesForm.child(new Knob(context)//
						...
						public void doTask() {
							//expectRequery.start(activityReports);
							activityReports.promptDeleteRepoort(ReportZayavkiNaUvelichenieLimita.this, currentKey);
						}
					})//
					                     .left().is(propertiesForm.shiftX.property.plus(Auxiliary.tapSize * (0.3 + 0 * 2.5)))//
