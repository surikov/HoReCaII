...
public class ReportProdajiFlagmanovPoKontragentam extends Report_Base {
    ...
    public ReportProdajiFlagmanovPoKontragentam(ActivityWebServicesReports p) {
        super(p);
    }

    public static String menuLabel() {
        return "Продажи флагманов по контрагентам";
    }

    public static String folderKey() {
        return "prodajiFlagmanovPoKontragentam";
    }
    ...
    public String composeGetQuery(int queryKind) {
        ...
        String p = "{" //
                ...
                + ",\"ВариантОтчета\":\"ПродажиФлагманов\""
                //+",\"Контрагент\":\""+kod+"\""//
                + kod//
                + "}";
        String e = "";
        ...
        if(propertiesForm == null) {
            ...
            propertiesForm.child(new Knob(context)//
                    ...
                    .afterTap.is(new Task() {
                        ...
                        public void doTask() {
                            //expectRequery.start(activityReports);
                            activityReports.promptDeleteRepoort(ReportProdajiFlagmanovPoKontragentam.this, currentKey);
                        }
                    })//
                    .left().is(propertiesForm.shiftX.property.plus(Auxiliary.tapSize * (0.3 + 0 * 2.5)))//
