...
public class ReportVipolneniePlanov extends Report_Base {
	...
	public ReportVipolneniePlanov(ActivityWebServicesReports p) {
		super(p);
	}

	public static String menuLabel() {
		return "Выполнение планов продаж";
	}

	public static String folderKey() {
		return "vipolneniePlanov";
	}
	...
	public String composeGetQuery(int queryKind) {
		...
		String p = "{" //
				...
				+ ",\"ВариантОтчета\":\"СводСТМ\""//ПродажиФлагманов
				+ "}";
		String e = "";
		try {
		...
		if(propertiesForm == null) {
			...
			propertiesForm.child(new Knob(context)//
					...
					.afterTap.is(new Task() {
						...
						public void doTask() {
							//expectRequery.start(activityReports);
							activityReports.promptDeleteRepoort(ReportVipolneniePlanov.this, currentKey);
						}
					})//
					.left().is(propertiesForm.shiftX.property.plus(Auxiliary.tapSize * (0.3 + 0 * 2.5)))//
