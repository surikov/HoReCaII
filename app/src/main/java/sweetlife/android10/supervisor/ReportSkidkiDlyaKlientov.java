...
public class ReportSkidkiDlyaKlientov extends Report_Base {

    Numeric who = new Numeric();

    public ReportSkidkiDlyaKlientov(ActivityWebServicesReports p) {
        super(p);
    }

    public static String menuLabel() {
        return "Скидки для клиентов";
    }

    public static String folderKey() {
        return "skidkiDlyaKlientov";
    }
        ...
        if (propertiesForm == null) {
            ...
            propertiesForm.child(new Knob(context)//
                    ...
                    .afterTap.is(new Task() {
                        ...
                        public void doTask() {
                            //expectRequery.start(activityReports);
                            activityReports.promptDeleteRepoort(ReportSkidkiDlyaKlientov.this, currentKey);
                        }
                    })//
                    .left().is(propertiesForm.shiftX.property.plus(Auxiliary.tapSize * (0.3 + 0 * 2.5)))//
