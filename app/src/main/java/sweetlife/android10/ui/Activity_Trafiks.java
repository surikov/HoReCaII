...
public class Activity_Trafiks extends Activity_Base implements ITableColumnsNames, OnTabChangeListener, ISearchBy {
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.act_trafiks);
	...
	private void InitializeGroupsListView() {
		...
		mNomenclatureGroupsListAdapter = new NomenclatureGroupsListAdapter(
				Request_Trafiks.RequestNomenlatureGroupsWithoutParent(mDB), this, true, mDB);
	...
	OnChildClickListener mOnChildGroupClickListener = new OnChildClickListener() {
		...
		public boolean onChildClick(ExpandableListView parent, View v,
			...
			UpdateNomenclatureListView(Request_Trafiks.getIDRRef(cursor));
