package sweetlife.android10.widgets;
...
public class BetterPopupWindow {
	 ...
	 */
	public BetterPopupWindow(View anchor, OnCloseListener closeListener) {
	...
	public void showLikeQuickAction(int xOffset, int yOffset) {
		System.out.println("showLikeQuickAction");
		this.preShow();
		...
		this.window.showAtLocation(this.anchor, Gravity.NO_GRAVITY, xPos, 150);//yPos);
	...
	public void dismiss(int param) {
		if (mOnCloseListener != null) {
			mOnCloseListener.onClose(param);
		}
		this.window.dismiss();
	}
}
